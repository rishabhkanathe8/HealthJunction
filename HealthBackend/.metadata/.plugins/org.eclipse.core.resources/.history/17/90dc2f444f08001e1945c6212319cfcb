...
public interface ExerciseRepository extends JpaRepository<Exercise, Integer> {
	...
	@Query("SELECT NEW com.healthJunction.dto.ExerciseAddDto(e.name, e.description, e.defficultyLevel, e.user.loginId) FROM Exercise e WHERE e.user.loginId = :loginId")
